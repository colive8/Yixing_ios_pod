Pod::Spec.new do |s|
  ...
  s.vendored_frameworks = 'yixingAd-1.5.0.xcframework'
  ...
  s.pod_target_xcconfig = {
    ...
    'ENABLE_BITCODE' => 'NO',
    'DEFINES_MODULE' => 'YES',
    'GCC_PREPROCESSOR_DEFINITIONS' => '$(inherited) GPB_USE_PROTOBUF_FRAMEWORK_IMPORTS=1 YIXINGAD_SDK_VERSION_CODE=1500'
  }
end
