Pod::Spec.new do |s|
  ...
  # 使用 XCFramework 二进制分发
  s.vendored_frameworks = 'yixingAd-1.4.xcframework'
  ...
  s.pod_target_xcconfig = {
    ...
    'ENABLE_BITCODE' => 'NO',
    'DEFINES_MODULE' => 'YES',
    'GCC_PREPROCESSOR_DEFINITIONS' => '$(inherited) GPB_USE_PROTOBUF_FRAMEWORK_IMPORTS=1 YIXINGAD_SDK_VERSION_CODE=1400'
  }
end
